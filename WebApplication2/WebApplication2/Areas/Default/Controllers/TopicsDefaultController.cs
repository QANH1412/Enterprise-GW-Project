...
namespace WebApplication2.Areas.Default.Controllers
{
    ...
    public class TopicsDefaultController : Controller
    {
        private IdeaManagementEntities db = new IdeaManagementEntities();

        // GET: Default/TopicsDefault
        public ActionResult Index()
        {
            return View(db.Topics.ToList());
        }

        // GET: Default/TopicsDefault/Details/5
        ...
        // GET: Default/TopicsDefault/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Default/TopicsDefault/Create
        ...
        // GET: Default/TopicsDefault/Edit/5
        ...
        // POST: Default/TopicsDefault/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Default/TopicsDefault/Delete/5
        ...
        // POST: Default/TopicsDefault/Delete/5
